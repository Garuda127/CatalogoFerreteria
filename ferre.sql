...
--
  ...
  --
INSERT INTO
  categorias (ID_Categorias, Nombre)
VALUES
  (1, 'Herramientas'),
...
--
  ...
  --
INSERT INTO
  imagenes (idImagenes, ImagenesUrl, productos_ID_producto)
VALUES
...
VALUES
  (
    ...
    'Voltek',
    10,
    'Clavija plastica, negra, Voltek',
    10,
    '/img/Productos/clavija/clavija.jpeg'
  ),
  (
    2,
    3,
  ...
  (
    ...
    'Pretul',
    95,
    'Martillo, 2 libras, mango de madera, Pretul.',
    3,
    '/img/missing.png'
  ),
  (
    ...
    'Igoto',
    24,
    'Extencion electrica de 2m, Igoto, economica.',
    5,
    '/img/missing.png'
  ),
  (
    ...
    'Pretul',
    30,
    'Lentes de seguridad, transparentes, Pretul.',
    10,
    '/img/missing.png'
  ),
  (
...
ALTER TABLE
  imagenes
ADD
  CONSTRAINT fk_imagenes_productos1 FOREIGN KEY (productos_ID_producto) REFERENCES productos (ID_producto);
--
